...
trait GeneralTrait
{
    ...
    public function getErrorCode($input)
    {
        if ($input == "name")
            ...
            return 'E002';
        else if ($input == "arrived_registration")
        return 'E0102';
        else if ($input == "Delivering_financial")
            return 'E0202';
        else if ($input == "photo_id")
            return 'E0302';
        else if ($input == "photo_card")
            return 'E0402';
        else if ($input == "donate_blood")
            return 'E0502';
        else if ($input == "acquittal_from_the_university")
            return 'E0602';
        else if ($input == "acquittal_from_housing")
            return 'E0702';
        else if ($input == "Clearance_of_credit_of_credit")
            return 'E0802';
            ...
            return 'E056';
        else if ($input == "verification_code")
            return 'E057';
        else if ($input == "user_name")
            return 'E058';
        else if ($input == "twitter_account")
            return 'E059';
        else if ($input == "role")
            return 'E060';
        else if ($input == "telephone_number")
            return 'E061';
        else if ($input == "mobile_phone_Number")
            return 'E062';
        else if ($input == "facebook_account")
            return 'E063';
        else if ($input == "telegram_account")
            return 'E064';
        else if ($input == "instagram_account")
            return 'E064';
        else if ($input == "country")
            return 'E065';
        else if ($input == "old_password")
            return 'E066';
        else if ($input == "confirmation_password")
            return 'E067';
